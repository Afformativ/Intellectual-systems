...
teachers = [Teacher(name) for name in
            ("0 Kulyabko", "1 Bohdan", "2 Derev'yanchenko", "3 Ryabokon", "4 Glibovec", "5 Fedorus",
             "6 Taranuha", "7 Yakovlev", "8 Kryvolap", "9 Vergunova", "10 Tkachenko", "11 Panchenko",
             "12 Shishatska", "13 Bobyl", "14 Trohimchuk", "15 Koval", "16 Pashko", "17 Krak","18 Nikitchenko", )]

subjects = [Subject(name) for name in
            ("0 Refactoring", "1 Pravo", "2 Paralelne", "3 Data Mining", "4 IS", "5 Telecommunication",
             "6 Management", "7 Korektnist", "8 BI", "9 Specifikaciya", "10 SQL", "11 Neuronni",
             "12 Rozpiznavannya", "13 OS", "14 Interface","15 Skladnist_algoritmiv", "16 Kvanti", "17 AI_problems", )]

groups = [Group(name) for name in
          ("MI", "TTP-41", "TTP-42", "TK-1", "TK-2", )]
